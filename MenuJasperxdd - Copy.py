...
class Game:
    def __init__(self):
        ...
        for i in range(0, 10):
            hiscores += str(interact_database("SELECT MAX(Correct), Name FROM Score GROUP BY Name, Correct ORDER BY Correct DESC LIMIT 1 OFFSET {};".format(i))[0][1])
            hiscores += ": "
            hiscores += str(interact_database("SELECT MAX(Correct), Name FROM Score GROUP BY Name, Correct ORDER BY Correct DESC LIMIT 1 OFFSET {};".format(i))[0][0])
            if i == 0:
                self.Score0 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 1:
                self.Score1 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 2:
                self.Score2 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 3:
                self.Score3 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 4:
                self.Score4 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 5:
                self.Score5 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 6:
                self.Score6 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 7:
                self.Score7 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 8:
                self.Score8 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
            elif i == 9:
                self.Score9 = Text(False, hiscores, (0, 0, 0), 960, 200 + (50*i))
        ...
        self.Menu_button4 = Button((self.width*0.8-(button_width/2)), (self.height*0.60), os.path.join("Images", "Play_Button_Normal.png"), os.path.join("Images", "Play_Button_Pressed.png"), buttonsize, "Score", True)
