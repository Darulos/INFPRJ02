...
class Game:
    def __init__(self):
        ...
        self.score = download_display_score()
    ...
    def update_score(self):
        self.score += 10
        upload_score(self.score, Player_Name)
...
# Start the program
Player_Name = input("Vul hier uw naam in. \n")
Player_Name = Player_Name.upper()
DBUser = input("Wat is de uw inlognaam voor Postgres? Deze waardes worden niet opgeslagen. \n")
DBPassword = input("Wat is uw wachtwoord voor Postgres? Deze waardes worden niet opgeslagen. \n")
interact_database("INSERT INTO Score VALUES(%s, %s);", True, (Player_Name, 0))
program()
