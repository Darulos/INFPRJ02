...
import Database, Variables, Input
...
class Avatar:
    ...
    def movement(self, number, direction):
        if Variables.dicecheck:
            ...
            if Variables.answer is True and Variables.movement != "":
...
class Question:
    ...
    def draw(self, screen, font):
        ...
        if (Variables.dicecheck == True) and (Variables.movement != ""):
            ...
            # Show the questions
            converteroutput = self.converter[0:30]
